...
{
    [DbContext(typeof(DoctorAshMigrationsDbContext))]
    [Migration("20220521201028_Renamed_CancellationReason_Column")]
    partial class Renamed_CancellationReason_Column
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorAsh.Appointments.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DoctorAsh.Doctors.Doctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DoctorAsh.Doctors.WorkingHour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppWorkingHours", (string)null);
                });

            modelBuilder.Entity("DoctorAsh.Patients.Patient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DoctorAsh.Appointments.Appointment", b =>
                {
                    b.HasOne("DoctorAsh.Doctors.Doctor", null)
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DoctorAsh.Patients.Patient", null)
                        .WithMany("Appointments")
